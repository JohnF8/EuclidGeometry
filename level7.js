...
// 				lines.push(new Segment(lastMouseDown.clientX - lastMouseDown.offsetX, lastMouseDown.clientY - lastMouseDown.offsetY, x, y));
// 			}
// 			if(toolbarState == "circle"){
// 				circles.push(new Circle(lastMouseDown.clientX - lastMouseDown.offsetX, lastMouseDown.clientY - lastMouseDown.offsetY, x, y));
// 			}
// 			lastMouseDown = null;
// 		}else{
// 			lastMouseDown = event;
...
// 		if(pointFound == 1){
// 			for (var i = lines.length - 1; i >= 0; i--) {
// 				if(lines[i].equals(new Segment(secondPoint.x, secondPoint.y, thirdPoint.x, thirdPoint.y))){
// 					thirdLines = lines[i];
// 					break;
// 				}
// 			}
...
// 		}else{
// 			for (var i = lines.length - 1; i >= 0; i--) {
// 				if(lines[i].equals(new Segment(firstPoint.x, firstPoint.y, thirdPoint.x, thirdPoint.y))){
// 					thirdLine = lines[i];
// 					break;
// 				}
// 			}
...
// 	if(point.x == line.x1 && point.y == line.y1){
